...
\input{chapters/02_optimalizacio}
\input{chapters/03_evolucios}
\input{chapters/04_genetikus}
\input{chapters/05_pso}
\input{chapters/06_kovetkeztetes}
\input{chapters/07_irodalomjegyzek}
